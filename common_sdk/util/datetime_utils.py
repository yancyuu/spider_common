...
class DateTime(object):
    ...
    def __init__(self, seconds=None, milliseconds=None, nanoseconds=None,
                 date_string=None, str_format='%Y-%m-%d %H:%M:%S',
                 timezone=TIMEZONE_BEIJING):
        self.timezone = pytz.timezone(timezone)
        self.reset_time(seconds=seconds, milliseconds=milliseconds, 
                    nanoseconds=nanoseconds, date_string=date_string, str_format=str_format)
    
    def reset_time(self, seconds=None, milliseconds=None, nanoseconds=None,
                   date_string=None, str_format='%Y-%m-%d %H:%M:%S'):
        # 初始化时间
        if seconds:
    ...
    def add_years(self, years):
        ...
        self.timestamp = int(self.datetime.replace(year=new_year).timestamp()
                     * self.NANOSECONDS_IN_ONE_SECOND)
        return self
    ...
    def add_months(self, months):
        ...
        self.timestamp = int(self.datetime.replace(year=new_year,
                    month=new_month).timestamp() * self.NANOSECONDS_IN_ONE_SECOND)
        return self
